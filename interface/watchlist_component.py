...
class Watchlist(tk.Frame):
    def __init__(self, master: tk.Frame, binance_contracts: dict, bitmex_contracts: dict, binance_spot_contracts: dict,
                 *args, **kwargs):
    ...
    # ADD THIS NEW METHOD so Root can call it:
    def load_watchlist(self, saved_symbols):
        """Populates the watchlist with data passed from the Root component."""
        if saved_symbols:
